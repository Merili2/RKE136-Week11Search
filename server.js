...
app.post('/search', (req, res) =>{
    ...
    let movieUrl= `https://api.themoviedb.org/3/search/movie?query=${userMovieTitle}&api_key=e87d2b634a8eea6acaf68df7752fc76e`;
    let genresUrl='https://api.themoviedb.org/3/genre/movie/list?api_key=e87d2b634a8eea6acaf68df7752fc76e';
